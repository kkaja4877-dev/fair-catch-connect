-- Fix the total_bid generated column issue
-- Remove the generated column and make it a regular column
ALTER TABLE bids DROP COLUMN total_bid;
ALTER TABLE bids ADD COLUMN total_bid NUMERIC DEFAULT 0;
